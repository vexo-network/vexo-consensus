...
Dieses Dokument behandelt RPC-API-Versionierung, Kompatibilitätsaliasse und Stabilitätspolitik. Befehle, JSON-Felder, RPC-Namen, config key und Code-Bezeichner, die in Implementierung und Betrieb verwendet werden, bleiben aus Kompatibilitätsgründen auf Englisch.
