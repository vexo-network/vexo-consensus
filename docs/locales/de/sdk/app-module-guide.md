...
Dieses Dokument behandelt das Erstellen eines app module und die Anbindung an CLI/RPC/State Storage. Befehle, JSON-Felder, RPC-Namen, config key und Code-Bezeichner, die in Implementierung und Betrieb verwendet werden, bleiben aus Kompatibilitätsgründen auf Englisch.
