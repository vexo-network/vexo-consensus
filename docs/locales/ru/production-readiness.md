# Руководство по готовности к эксплуатации
...
Vexo объединяет BFT-консенсус, модули приложения, нативный учёт, опциональное EVM-исполнение, экономику валидаторов, peer-сеть и release evidence. Читатель должен уметь объяснить не только наличие функции, но и то, как безопасно её эксплуатировать и как доказать её работу в целевой сети.
