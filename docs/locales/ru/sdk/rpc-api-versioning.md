...
Этот документ описывает версионирование RPC API, совместимые alias и политику стабильности. Команды, JSON-поля, имена RPC, config key и идентификаторы кода, используемые в реализации и эксплуатации, сохраняются на английском для совместимости.
