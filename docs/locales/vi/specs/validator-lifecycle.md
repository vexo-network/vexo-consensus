...
Tài liệu này trình bày vòng đời validator join, rotation, jail, slashing và leave. Lệnh, trường JSON, tên RPC, config key và định danh mã dùng trong triển khai và vận hành được giữ bằng tiếng Anh để đảm bảo tương thích.
