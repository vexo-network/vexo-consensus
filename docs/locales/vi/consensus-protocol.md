...
Tài liệu này giúp hiểu mô hình đồng thuận, thuật ngữ execution/commit/finality và ranh giới an toàn và liên hệ nội dung đó với quyết định triển khai, vận hành.

- Canonical path: `docs/consensus-protocol.md`
- Locale path: `docs/locales/vi/consensus-protocol.md`

## Vì sao nên đọc tài liệu này

- mô hình đồng thuận, thuật ngữ execution/commit/finality và ranh giới an toàn
