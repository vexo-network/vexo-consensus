...
Dokumen ini membahas aturan transaction format, signing, fee, dan gas. Perintah, field JSON, nama RPC, config key, dan identifier kode yang dipakai dalam implementasi serta operasi tetap berbahasa Inggris demi kompatibilitas.
