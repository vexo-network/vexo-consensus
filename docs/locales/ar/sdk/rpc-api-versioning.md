...
يوضح هذا المستند إدارة إصدارات RPC API وأسماء التوافق وسياسة الاستقرار. تبقى الأوامر وحقول JSON وأسماء RPC وconfig key ومعرّفات الكود المستخدمة في التنفيذ والتشغيل باللغة الإنجليزية للحفاظ على التوافق.
