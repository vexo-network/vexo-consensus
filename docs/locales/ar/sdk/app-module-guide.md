...
يوضح هذا المستند إنشاء app module وربطه مع CLI/RPC وتخزين الحالة. تبقى الأوامر وحقول JSON وأسماء RPC وconfig key ومعرّفات الكود المستخدمة في التنفيذ والتشغيل باللغة الإنجليزية للحفاظ على التوافق.
