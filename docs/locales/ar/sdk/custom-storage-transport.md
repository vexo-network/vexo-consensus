...
يوضح هذا المستند تنفيذ وتسجيل custom storage وtransport adapter. تبقى الأوامر وحقول JSON وأسماء RPC وconfig key ومعرّفات الكود المستخدمة في التنفيذ والتشغيل باللغة الإنجليزية للحفاظ على التوافق.
