...
هذا المستند مفيد لمن ينشئ node home لأول مرة ولمن يدير نودات بالفعل. إذا كانت هذه أول قراءة لك، فاتبع هذا الترتيب.

1. ما الذي تبنيه
2. تشغيل محلي خلال خمس دقائق
3. شبكة محلية من أربعة validators
4. Web3 و Remix
5. Validator Node
6. Archive Node
...
هذا الترتيب يطابق ما يجب على المشغّل التحقق منه أولاً: فهم معنى node home، ثم التأكد من التشغيل المحلي، ثم التمييز بين validator وarchive، وبعد ذلك مراجعة peers والتوقيت والتعامل مع الأعطال.
