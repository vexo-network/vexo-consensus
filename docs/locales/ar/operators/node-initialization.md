...
يوضح هذا المستند تهيئة عقد archive وvalidator وتشغيل ملفات الإعداد المنفصلة. تبقى الأوامر وحقول JSON وأسماء RPC وconfig key ومعرّفات الكود المستخدمة في التنفيذ والتشغيل باللغة الإنجليزية للحفاظ على التوافق.
