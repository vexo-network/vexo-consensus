...
Vexo는 BFT 합의, application module, 네이티브 회계, 선택적 EVM 실행, validator 경제, 피어 네트워킹, release evidence를 함께 다룹니다. 사용자는 기능이 있다는 사실뿐 아니라, 안전하게 운영하는 방법과 대상 네트워크에서 동작을 어떻게 증명하는지도 설명할 수 있어야 합니다.
