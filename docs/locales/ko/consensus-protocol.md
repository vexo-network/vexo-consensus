...
이 문서는 합의 모델, execution/commit/finality 용어, 안전성 경계을 이해하고 실제 구현·운영 판단에 연결하도록 돕습니다. 예제와 식별자는 구현 호환성을 위해 영어 표기를 유지하지만, 읽는 흐름과 운영상 판단 기준은 한국어로 설명합니다.

- Canonical path: `docs/consensus-protocol.md`
- Locale path: `docs/locales/ko/consensus-protocol.md`

## 이 문서를 읽는 이유

- 합의 모델, execution/commit/finality 용어, 안전성 경계
...
- [영어 정본 문서](../en/consensus-protocol.md)
