...
Este documento cobre conexão consistente entre native coin e EVM gas/accounting. Comandos, campos JSON, nomes RPC, config key e identificadores de código usados na implementação e operação permanecem em inglês por compatibilidade.
