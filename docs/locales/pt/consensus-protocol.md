...
Este documento cobre o modelo de consenso, termos de execução/finality e limite de segurança. Comandos, campos JSON, nomes RPC, config key e identificadores de código usados na implementação e operação permanecem em inglês por compatibilidade.
