...
- gRPC peer transport with binary framing, persistent streams, protocol/network/chain/genesis/node-id handshake validation, message-size limits, and send retry after stale-session failures
