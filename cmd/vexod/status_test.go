...
func TestWriteStatusJSON(t *testing.T) {
	...
	if len(document.Application.Modules) != 2 || document.Application.Modules[0] != "bank" || document.Application.Modules[1] != "staking" {
