...
func TestWriteStatusJSON(t *testing.T) {
	...
	if document.Storage.Backend != "leveldb" || !document.Features["peer_scoring"] || !document.Features["height_salted_order"] || !document.Features["deployment_audit"] || !document.Features["addr_book"] || !document.Features["addr_book_ban_evict"] || !document.Features["peer_dial_tracking"] || !document.Features["transport_peer_gate"] || !document.Features["consensus_gossip_scoring"] || !document.Features["banned_peer_disconnect"] || !document.Features["peer_score_persistence"] || !document.Features["state_sync_snapshot_kv"] || !document.Features["state_sync_checksum"] || !document.Features["state_sync_verify"] || !document.Features["state_sync_snapshot_chunks"] || !document.Features["web3_receipt_roots"] || !document.Features["web3_global_log_filters"] || !document.Features["ops_metrics_uptime"] || !document.Features["ops_pprof_optional"] || !document.Features["ops_structured_logs"] || !document.Features["ops_release_artifacts"] || !document.Features["ops_external_audit_pack"] || !document.Features["ops_deployment_template"] || !document.Features["ops_longrun_network_plan"] || !document.Features["security_fuzz_targets"] || !document.Features["security_strict_json_rpc"] || !document.Features["security_forwarded_for_untrusted"] || !document.Features["consensus_adversarial_simulation"] || !document.Features["consensus_partition_safety"] || !document.Features["consensus_tendermint_timeouts"] || !document.Features["consensus_empty_block_control"] || !document.Features["consensus_app_hash_evidence"] || !document.Features["crypto_remote_signer_verification"] || !document.Features["crypto_bls_adapter_required"] {
