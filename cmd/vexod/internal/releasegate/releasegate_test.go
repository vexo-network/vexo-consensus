...
func TestEvidenceSemanticValidation(t *testing.T) {
	for _, testCase := range []struct {
		...
		{name: "sdk conformance accepted without evm", checkName: "sdk_conformance_evidence", path: "sdk.json", data: []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evidence passed"}`), ok: true},
		{name: "evm web3 conformance requires fixtures", checkName: "evm_web3_conformance_evidence", path: "evm.json", data: []byte(`{"ok":true,"summary":"evm web3 ethereum json-rpc trace debug gas base-fee fee blob native-coin vexo evidence passed"}`), ok: false},
		{name: "evm web3 conformance fixtures accepted", checkName: "evm_web3_conformance_evidence", path: "evm.json", data: []byte(`{"ok":true,"summary":"evm web3 ethereum json-rpc trace debug gas base-fee fee blob native-coin vexo raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"web3_rpc":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["json_rpc","trace","gas","fee","blob","native_coin"],"covered_categories":["json_rpc","trace","gas","fee","blob","native_coin"],"results":[{"ok":true,"name":"web3"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: true},
		{name: "evm web3 conformance rejects builtin corpus source", checkName: "evm_web3_conformance_evidence", path: "evm.json", data: []byte(`{"ok":true,"summary":"evm web3 ethereum json-rpc trace debug gas base-fee fee blob native-coin vexo raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"web3_rpc":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["json_rpc"],"covered_categories":["json_rpc"],"results":[{"ok":true,"name":"web3"}]},"evm_corpus":{"transaction":{"source":"built-in","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: false},
		{name: "evm web3 conformance rejects empty corpus count", checkName: "evm_web3_conformance_evidence", path: "evm.json", data: []byte(`{"ok":true,"summary":"evm web3 ethereum json-rpc trace debug gas base-fee fee blob native-coin vexo raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"web3_rpc":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["json_rpc"],"covered_categories":["json_rpc"],"results":[{"ok":true,"name":"web3"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":0},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: false},
...
func completeReleaseGateEvidence(skipExternal bool) Evidence {
	...
	evidence := Evidence{
		...
		EVMWeb3Conformance:   "evm-web3-conformance.json",
		Exists: func(path string) bool {
			_, found := files[path]
			return found
		},
...
func completeReleaseGateEvidenceFiles(skipExternal bool) map[string][]byte {
	files := map[string][]byte{
		...
		"evm-web3-conformance.json":    semanticEvidenceContentForPath("evm-web3-conformance.json"),
	}
	if !skipExternal {
...
func releaseGateEvidenceName(path string) string {
	...
	case "evm-web3-conformance.json":
		return "evm_web3_conformance_evidence"
	case "audit.pdf":
...
func semanticEvidenceContentForPath(path string) []byte {
	...
	case "sdk-conformance.json":
		return []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evidence passed"}`)
	case "evm-web3-conformance.json":
		return []byte(`{"ok":true,"summary":"evm web3 ethereum json-rpc trace debug gas base-fee fee blob native-coin vexo raw transaction fixtures vm execution opcode evidence passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"web3_rpc":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["json_rpc","trace","gas","fee","blob","native_coin"],"covered_categories":["json_rpc","trace","gas","fee","blob","native_coin"],"results":[{"ok":true,"name":"web3"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`)
	case "audit.pdf":
