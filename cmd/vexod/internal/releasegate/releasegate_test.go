...
func TestEvidenceSemanticValidation(t *testing.T) {
	for _, testCase := range []struct {
		...
		{name: "sdk conformance fixtures accepted", checkName: "sdk_conformance_evidence", path: "sdk.json", data: []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evm web3 ethereum raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: true},
		{name: "sdk conformance rejects builtin corpus source", checkName: "sdk_conformance_evidence", path: "sdk.json", data: []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evm web3 ethereum raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"evm_corpus":{"transaction":{"source":"built-in","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: false},
		{name: "sdk conformance rejects empty corpus count", checkName: "sdk_conformance_evidence", path: "sdk.json", data: []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evm web3 ethereum raw transaction fixtures vm execution opcode passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":0},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`), ok: false},
...
func semanticEvidenceContentForPath(path string) []byte {
	...
	case "sdk-conformance.json":
		return []byte(`{"ok":true,"summary":"sdk api conformance module rpc storage crypto transport ibc relayer proof evm web3 ethereum raw transaction fixtures vm execution opcode evidence passed","evm_fixtures":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["raw_transaction"],"covered_categories":["raw_transaction"],"results":[{"ok":true,"name":"tx"}]},"evm_execution":{"ok":true,"total":1,"passed":1,"failed":0,"coverage_ok":true,"required_categories":["opcode"],"covered_categories":["opcode"],"results":[{"ok":true,"name":"vm"}]},"evm_corpus":{"transaction":{"source":"file","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","fixture_count":1},"execution":{"source":"file","sha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","fixture_count":1}}}`)
	case "audit.pdf":
